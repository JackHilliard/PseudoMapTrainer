...
Copied from the sibling MapTRv2 codebase (tools/maptrv2/dataset_viewer.py).
It reads CARLA exports, not nuScenes, so it does not view this repo's own
pseudo-label output -- for that see RoGS/mwe.ipynb.
